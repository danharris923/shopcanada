...
export const storeLogos: Record<string, StoreInfo> = {
  ...
  'abercrombie': {
    ...
    logo: gfav('abercrombie.com'),
    color: 'bg-[#1A1A1A]',
    tagline: 'Abercrombie Canada deals on casual wear, denim, and essentials',
    topCategories: ['casual wear', 'denim', 'essentials'],
    badges: ['international', 'ships-from-canada'],
  },
  'american-eagle': {
    slug: 'american-eagle',
    ...
    logo: gfav('ae.com'),
    color: 'bg-[#003B5C]',
    tagline: 'American Eagle Canada deals on jeans, casual wear, and loungewear',
    topCategories: ['jeans', 'casual wear', 'loungewear'],
    badges: ['international', 'ships-from-canada'],
  },
  'aerie': {
    slug: 'aerie',
    ...
    logo: gfav('ae.com'),
    color: 'bg-[#F5A3B7]',
    tagline: 'Aerie Canada deals on lingerie, loungewear, and activewear',
    topCategories: ['lingerie', 'loungewear', 'activewear'],
    badges: ['international', 'ships-from-canada'],
  },
  'alo-yoga': {
    slug: 'alo-yoga',
    name: 'Alo Yoga',
    domain: 'aloyoga.com',
    logo: gfav('aloyoga.com'),
    color: 'bg-[#000000]',
    tagline: 'Alo Yoga Canada deals on yoga wear, leggings, and athleisure',
    topCategories: ['yoga wear', 'leggings', 'athleisure'],
    badges: ['international', 'ships-from-canada'],
  },
  'guess': {
    slug: 'guess',
    ...
    logo: gfav('guess.com'),
    color: 'bg-[#000000]',
    tagline: 'GUESS Canada deals on fashion, denim, and accessories',
    topCategories: ['fashion', 'denim', 'accessories'],
    badges: ['international', 'ships-from-canada'],
  },
  'skims': {
    slug: 'skims',
    ...
    logo: gfav('skims.com'),
    color: 'bg-[#D4C4B5]',
    tagline: 'SKIMS Canada: Free shipping $115+ CAD, duties included at checkout',
    topCategories: ['shapewear', 'loungewear', 'essentials'],
    badges: ['international', 'ships-from-canada'],
  },
  'revolve': {
    slug: 'revolve',
    name: 'Revolve',
    domain: 'revolve.com',
    logo: gfav('revolve.com'),
    color: 'bg-[#000000]',
    tagline: 'Revolve Canada: FREE 2-day express, CAD pricing, free returns',
    topCategories: ['designer fashion', 'dresses', 'shoes'],
    badges: ['international', 'ships-from-canada'],
  },
  'princess-polly': {
    slug: 'princess-polly',
    ...
    logo: gfav('princesspolly.com'),
    color: 'bg-[#FFB6C1]',
    tagline: 'Princess Polly Canada: Ships from US, duties included at checkout',
    topCategories: ['trendy fashion', 'dresses', 'tops'],
    badges: ['international', 'ships-from-canada'],
  },
  'shopbop': {
    slug: 'shopbop',
    name: 'Shopbop',
    domain: 'shopbop.com',
    logo: gfav('shopbop.com'),
    color: 'bg-[#000000]',
    tagline: 'Shopbop Canada: Free shipping $125+ CAD, Amazon-owned',
    topCategories: ['designer fashion', 'bags', 'shoes'],
    badges: ['international', 'ships-from-canada'],
  },
  'vuori': {
    slug: 'vuori',
    ...
    logo: gfav('vuoriclothing.com'),
    color: 'bg-[#2D5F5D]',
    tagline: 'Vuori Canada: Ships direct or shop at Sporting Life & Altitude Sports',
    topCategories: ['activewear', 'joggers', 'performance wear'],
    badges: ['international', 'ships-from-canada'],
  },
  'lulus': {
    slug: 'lulus',
    ...
    logo: gfav('lulus.com'),
    color: 'bg-[#000000]',
    tagline: 'Lulus Canada: $9.99 CAD shipping, free on orders $99+ USD',
    topCategories: ['dresses', 'wedding guest', 'occasion wear'],
    badges: ['international', 'ships-from-canada'],
  },
  'madewell': {
    slug: 'madewell',
    name: 'Madewell',
    domain: 'madewell.com',
    logo: gfav('madewell.com'),
    color: 'bg-[#1A1A1A]',
    tagline: 'Madewell Canada: Ships via ESW, duties paid on delivery',
    topCategories: ['denim', 'totes', 'everyday essentials'],
    badges: ['international', 'ships-from-canada'],
  },
  'anthropologie': {
    slug: 'anthropologie',
    ...
    logo: gfav('anthropologie.com'),
    color: 'bg-[#2C4A52]',
    tagline: 'Anthropologie Canada: Ships to CA, import fee option at checkout',
    topCategories: ['boho fashion', 'home', 'gifts'],
    badges: ['international', 'ships-from-canada'],
  },
  'free-people': {
    slug: 'free-people',
    ...
    logo: gfav('freepeople.com'),
    color: 'bg-[#8B4513]',
    tagline: 'Free People Canada: Ships direct or shop at Simons',
    topCategories: ['boho fashion', 'dresses', 'activewear'],
    badges: ['international', 'ships-from-canada'],
  },
  'cotton-on': {
    slug: 'cotton-on',
    name: 'Cotton On',
    domain: 'cottonon.com',
    logo: gfav('cottonon.com'),
    color: 'bg-[#000000]',
    tagline: 'Cotton On Canada deals on casual fashion, basics, and accessories',
    topCategories: ['casual fashion', 'basics', 'accessories'],
    badges: ['international', 'ships-from-canada'],
  },
  'nasty-gal': {
    slug: 'nasty-gal',
    name: 'Nasty Gal',
    domain: 'nastygal.com',
    logo: gfav('nastygal.com'),
    color: 'bg-[#000000]',
    tagline: 'Nasty Gal Canada deals on edgy fashion, dresses, and shoes',
    topCategories: ['edgy fashion', 'dresses', 'shoes'],
    badges: ['international', 'ships-from-canada'],
  },
  'prettylittlething': {
    slug: 'prettylittlething',
    name: 'PrettyLittleThing',
    domain: 'prettylittlething.ca',
    logo: gfav('prettylittlething.com'),
    color: 'bg-[#FFB6C1]',
    tagline: 'PrettyLittleThing Canada deals on trendy fashion, dresses, and swimwear',
    topCategories: ['trendy fashion', 'dresses', 'swimwear'],
    badges: ['international', 'ships-from-canada'],
  },
  'urban-outfitters': {
    ...
    logo: gfav('urbanoutfitters.com'),
    color: 'bg-[#000000]',
    tagline: 'Urban Outfitters Canada deals on fashion, home, and lifestyle',
    topCategories: ['fashion', 'home', 'lifestyle'],
    badges: ['international', 'ships-from-canada'],
  },
  'steve-madden': {
    slug: 'steve-madden',
    name: 'Steve Madden',
    domain: 'stevemadden.ca',
    logo: gfav('stevemadden.com'),
    color: 'bg-[#000000]',
    tagline: 'Steve Madden Canada deals on shoes, boots, and handbags',
    topCategories: ['shoes', 'boots', 'handbags'],
    badges: ['international', 'ships-from-canada'],
  },
  'new-balance': {
    slug: 'new-balance',
    name: 'New Balance',
    domain: 'newbalance.ca',
    logo: gfav('newbalance.com'),
    color: 'bg-[#CF0A2C]',
    tagline: 'New Balance Canada deals on running shoes, sneakers, and athletic wear',
    topCategories: ['running shoes', 'sneakers', 'athletic wear'],
    badges: ['international', 'ships-from-canada'],
  },
  'birkenstock': {
    slug: 'birkenstock',
    name: 'Birkenstock',
    domain: 'birkenstock.ca',
    logo: gfav('birkenstock.com'),
    color: 'bg-[#1A1A1A]',
    tagline: 'Birkenstock Canada deals on sandals, clogs, and comfort footwear',
    topCategories: ['sandals', 'clogs', 'comfort footwear'],
    badges: ['international', 'ships-from-canada'],
  },
  'ugg': {
    slug: 'ugg',
    ...
    logo: gfav('ugg.com'),
    color: 'bg-[#B5985A]',
    tagline: 'UGG Canada deals on boots, slippers, and cozy footwear',
    topCategories: ['boots', 'slippers', 'cozy footwear'],
    badges: ['international', 'ships-from-canada'],
  },
  'simons': {
    slug: 'simons',
    ...
    logo: gfav('simons.ca'),
    color: 'bg-[#000000]',
    tagline: 'Simons Canada deals on fashion, home decor, and designer brands',
    topCategories: ['fashion', 'home decor', 'designer brands'],
    badges: ['canadian-owned', 'canadian-retailer', 'ships-from-canada'],
    isCanadian: true,
  },
  ...
  'charlotte-tilbury': {
    ...
    logo: gfav('charlottetilbury.com'),
    color: 'bg-[#D4AF37]',
    tagline: 'Charlotte Tilbury Canada deals on luxury makeup and skincare',
    topCategories: ['luxury makeup', 'skincare', 'lipstick'],
    badges: ['international', 'ships-from-canada'],
  },
  'tarte': {
    slug: 'tarte',
    ...
    logo: gfav('tartecosmetics.com'),
    color: 'bg-[#9B59B6]',
    tagline: 'Tarte Canada deals on clean beauty, makeup, and skincare',
    topCategories: ['clean beauty', 'makeup', 'skincare'],
    badges: ['international', 'ships-from-canada'],
  },
  'elf': {
    slug: 'elf',
    ...
    logo: gfav('elfcosmetics.com'),
    color: 'bg-[#000000]',
    tagline: 'e.l.f. Canada deals on affordable makeup, skincare, and tools',
    topCategories: ['affordable makeup', 'skincare', 'tools'],
    badges: ['international', 'ships-from-canada'],
  },
  'tula': {
    slug: 'tula',
    ...
    logo: gfav('tula.com'),
    color: 'bg-[#4ECDC4]',
    tagline: 'Tula Canada deals on probiotic skincare and clean beauty',
    topCategories: ['probiotic skincare', 'clean beauty', 'serums'],
    badges: ['international', 'ships-from-canada'],
  },
  'colleen-rothschild': {
    slug: 'colleen-rothschild',
    name: 'Colleen Rothschild',
    domain: 'colleenrothschild.com',
    logo: gfav('colleenrothschild.com'),
    color: 'bg-[#2C3E50]',
    tagline: 'Colleen Rothschild Canada deals on luxury skincare and anti-aging',
    topCategories: ['luxury skincare', 'anti-aging', 'cleansers'],
    badges: ['international', 'ships-from-canada'],
  },
  'dime-beauty': {
    slug: 'dime-beauty',
    name: 'Dime Beauty',
    domain: 'dimebeauty.co',
    logo: gfav('dimebeauty.co'),
    color: 'bg-[#F5E6D3]',
    tagline: 'Dime Beauty Canada deals on clean skincare and serums',
    topCategories: ['clean skincare', 'serums', 'retinol'],
    badges: ['international', 'ships-from-canada'],
  },
  'merit': {
    slug: 'merit',
    ...
    logo: gfav('meritbeauty.com'),
    color: 'bg-[#E8DED1]',
    tagline: 'Merit Canada deals on minimalist makeup and clean beauty',
    topCategories: ['minimalist makeup', 'clean beauty', 'lip products'],
    badges: ['international', 'ships-from-canada'],
  },
  'supergoop': {
    slug: 'supergoop',
    ...
    logo: gfav('supergoop.com'),
    color: 'bg-[#FFD700]',
    tagline: 'Supergoop Canada deals on SPF, sunscreen, and sun protection',
    topCategories: ['SPF', 'sunscreen', 'sun protection'],
    badges: ['international', 'ships-from-canada'],
  },
  ...
  'crate-and-barrel': {
    ...
    logo: gfav('crateandbarrel.com'),
    color: 'bg-[#000000]',
    tagline: 'Crate & Barrel Canada deals on furniture, decor, and kitchenware',
    topCategories: ['furniture', 'decor', 'kitchenware'],
    badges: ['international', 'ships-from-canada'],
  },
  'pottery-barn': {
    slug: 'pottery-barn',
    ...
    logo: gfav('potterybarn.com'),
    color: 'bg-[#1A1A1A]',
    tagline: 'Pottery Barn Canada deals on furniture, bedding, and home decor',
    topCategories: ['furniture', 'bedding', 'home decor'],
    badges: ['international', 'ships-from-canada'],
  },
  'west-elm': {
    slug: 'west-elm',
    name: 'West Elm',
    domain: 'westelm.ca',
    logo: gfav('westelm.com'),
    color: 'bg-[#000000]',
    tagline: 'West Elm Canada deals on modern furniture, decor, and lighting',
    topCategories: ['modern furniture', 'decor', 'lighting'],
    badges: ['international', 'ships-from-canada'],
  },
  'cb2': {
    slug: 'cb2',
    ...
    logo: gfav('cb2.com'),
    color: 'bg-[#000000]',
    tagline: 'CB2 Canada deals on modern furniture, decor, and outdoor',
    topCategories: ['modern furniture', 'decor', 'outdoor'],
    badges: ['international', 'ships-from-canada'],
  },
  'dyson': {
    slug: 'dyson',
    ...
    logo: gfav('dyson.com'),
    color: 'bg-[#000000]',
    tagline: 'Dyson Canada deals on vacuums, hair tools, and air purifiers',
    topCategories: ['vacuums', 'hair tools', 'air purifiers'],
    badges: ['international', 'ships-from-canada'],
  },
  'brooklinen': {
    slug: 'brooklinen',
    ...
    logo: gfav('brooklinen.com'),
    color: 'bg-[#1A1A1A]',
    tagline: 'Brooklinen Canada deals on luxury bedding, sheets, and towels',
    topCategories: ['luxury bedding', 'sheets', 'towels'],
    badges: ['international', 'ships-from-canada'],
  },
}
