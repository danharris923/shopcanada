...
export const metadata: Metadata = {
  title: 'Terms of Service - Click & Save Canada',
  description: 'Terms and conditions for using Click & Save Canada. Read about our affiliate relationships, user responsibilities, and site usage policies.',
  alternates: {
        ...
        <section className="py-12 px-4">
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-card p-8 shadow-soft prose prose-slate max-w-none">
              ...
              <p>
                By accessing and using Click & Save Canada (clickandsavecanada.com), you agree to be bound by these Terms of Service.
              ...
              <p>
                Click & Save Canada is a deal aggregation website that displays product deals and discounts from various
              ...
              <p>
                Click & Save Canada participates in affiliate marketing programs, including the Amazon Associates Program
              ...
              <p>
                ...
                Click & Save Canada is not responsible for pricing errors or out-of-stock items.
              </p>

              <h2>User Responsibilities</h2>
              <p>
                When using Click & Save Canada, you agree to:
              </p>
              <ul>
              ...
              <p>
                The Click & Save Canada website, including its design, logos, and original content, is protected by
              ...
              <p>
                Click & Save Canada provides deal information on an "as is" basis without warranties of any kind. We are
              ...
              <p>
                ...
                of Click & Save Canada shall be resolved in accordance with Canadian law.
              </p>
              ...
              <p>
                ...
                information about Click & Save Canada.
              </p>
            </div>
          </div>
        </section>
