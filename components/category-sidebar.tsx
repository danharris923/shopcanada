      ...
      <div className="sticky top-24 bg-[#1a2a1a] border-2 border-[#3a4a3a] p-6">
        ...
        <div className="mt-8 pt-6 border-t border-[#3a4a3a]">
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <Link href="/all-brands" className="text-[#b8a896] hover:text-[#b8860b]">
                • All Brands A-Z
              </Link>
            </li>
            <li>
              <Link href="/brands" className="text-[#b8a896] hover:text-[#b8860b]">
                • Featured Brands
              </Link>
            </li>
            <li>
              <Link href="/reviews" className="text-[#b8a896] hover:text-[#b8860b]">
                • Reviews
              </Link>
            </li>
          </ul>
        ...
        <div className="mt-6 p-4 bg-[#0f1410] border border-[#3a4a3a] text-center">
          ...
          <Link href="/all-brands" className="text-[#b8860b] hover:text-[#d4a520] text-sm font-bold">
            View All Brands A-Z →
          </Link>
        </div>
      </div>
